...
class Ufuatiliaji extends StatefulWidget {
  const Ufuatiliaji({Key? key}) : super(key: key);

  @override
  State<Ufuatiliaji> createState() => _UfuatiliajiState();
}

class _UfuatiliajiState extends State<Ufuatiliaji> {
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text('Ufuatiliaji wa Ombi',style: TextStyle(
                      fontSize: 20,
